...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		if (guess.equalsIgnoreCase("Arnold Schwarzenegger")){
			JOptionPane.showMessageDialog(null,"Wow how did you know!");
			score = score +1;
		...
		// -- Tell them they are wrong and who the person is
			...
			JOptionPane.showMessageDialog(null, "Incorrect. This is Arnold Schwarzenegger");
		}
		...
		if (guess.equalsIgnoreCase("Leonardo Dicaprio")){
			...
			JOptionPane.showMessageDialog(null, "Incorrect. This is Leonardo DiCaprio");
		}
